...
const plans = [
  {
    ...
    price: 20,
    badge: 'Začína od 20 €',
    description: 'Rýchla úprava brandu a základný voucher flow.',
    features: [
      'Vložíme vaše logo a farby',
      'Výber z 5 šablón',
      'Okamžitá e‑mailová distribúcia',
  ...
  },
  {
    ...
    description: 'Prémiový Customizer s vlastnou šablónou na mieru.',
    features: [
      'Vlastná šablóna na mieru',
  ...
  },
  {
    name: 'Custom Elite',
    price: 89,
    badge: 'Rozšírené integrácie',
    description: 'Full white-label a špeciálne integrácie pre siete prevádzok.',
    features: [
      'White-label brand (bez Terminar)',
      'Napojenie na CRM / API',
      'Vlastné PDF + mobilný voucher',
      'Rozšírená evidencia a exporty',
      'Onboarding pre tím'
    ],
  ...
  return (
    <section id="customizer" className="relative bg-slate-950 text-white py-20 overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-10 right-10 w-72 h-72 bg-sky-500/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-10 space-y-12">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">
            Vlastné poukážky na mieru
          </h2>
          <p className="text-gray-300 max-w-3xl mx-auto">
            Vyrobíme vám šablónu na mieru, automatický generátor dizajnu a elektronickú distribúciu. Customizer je prémiová služba pripravená zapadnúť do vášho rezervačného systému.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
          {[
            { icon: <Palette className="w-5 h-5" />, text: 'Vlastná šablóna na mieru' },
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`relative rounded-3xl border border-white/10 bg-slate-900/70 p-8 shadow-xl flex flex-col gap-5 ${
            ...
            >
              ...
              <button
                className="mt-2 w-full py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-emerald-500 to-teal-500 shadow-lg hover:shadow-xl transition-all"
              >
                Chcem Customizer
              </button>
            </div>
